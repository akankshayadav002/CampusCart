...
Campus Cart is  campus-focused marketplace where students can buy, sell, rent, and even report lost items. It is built as a MERN-stack project with a React + Vite frontend and an Express + MongoDB backend.

## Screenshots

### Home Page
![Campus Cart Home](./client//src/images/campuscart.png)
